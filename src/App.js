...
function App () {
  ...
  // render() {
    return (
      <Router>
        <Routes>
          <Route exact path="/" element={<MainPage temperature={temperature}
                                                    alarm={security.alarm}
                                                    door={security.door}
                                                    garage={security.garage}
                                                    comfort={comfort} />}/>
          <Route exact path="/secure" 
              element={<SecurePage alarm={security.alarm}
                                    door={security.door}
                                    garage={security.garage}
                                    onUpdte={(value, type) => onUpdateSecurity(value, type)} />}/>
          <Route exact path="/comfort" 
              element={<ComfortPage comfort={comfort} temperature={temperature}
